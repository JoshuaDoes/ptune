echo ""
echo "Installing: Pixel Tune v2.0.0-alpha13"
echo ""
...
RD="$MODDIR/system"
RDS="$MODDIR/systems"
TARGETS="$BRAND $SOC $BRAND.$SOC $RELEASE $BOARD $DEVICE $RELEASE.$BOARD $RELEASE.$DEVICE $BOARD.$DEVICE $RELEASE.$BOARD.$DEVICE $FINGERPRINT"
